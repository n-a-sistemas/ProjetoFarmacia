    ...
    <main>
        <form action="../PHP/update_formulario.php" method="POST" enctype="multipart/form-data" onsubmit="return validaFormulario();">
            ...
            <div>
                ...
                <textarea name="alergias_doencas" id="alergias_doencas" cols="30" rows="10" required><?php echo $alergiadoencas ?></textarea>
            </div>
            <div>
                <label for="plano_de_saude">*Plano de saúde: </label>
                <input type="text" name="plano_de_saude" id="plano_de_saude" value="<?php echo $planodesaude ?>" required>
            </div>
            <div>
